...
CREATE TABLE doctors (
    ...
    medical_council_code VARCHAR(64) NULL -- Added new field
) AUTO_INCREMENT = 1;
...
CREATE PROCEDURE AddDoctor(
    ...
    IN p_medical_council_code VARCHAR(64) -- Added parameter
)
BEGIN
    INSERT INTO doctors (
        first_name, last_name, national_code, gender,
        phone_number, password, medical_council_code
    ) 
    VALUES (
        p_first_name, p_last_name, p_national_code, p_gender,
        p_phone_number, p_password, p_medical_council_code
    );
END //
...
-- Modified UpdateDoctor procedure to include medical_council_code
...
BEGIN
    ...
    SET 
        ...
        address = p_address,
        profile_photo_path = p_profile_photo_path,
        medical_council_code = p_medical_council_code -- Added field
    WHERE id = p_id;
END //
